    ...
    public void alert() {
        ...
        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(getBaseContext(),"OK Button is pressed",Toast.LENGTH_SHORT).show();
            }
        });
...
//        });
        alertDialog.setNeutralButton("CANCEL",(dialog, which) -> {
            Toast.makeText(getBaseContext(),"CANCEL Button is pressed",Toast.LENGTH_SHORT).show();
        });
