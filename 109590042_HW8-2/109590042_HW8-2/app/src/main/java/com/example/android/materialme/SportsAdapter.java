    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ActivityOptionsCompat option = ActivityOptionsCompat.makeSceneTransitionAnimation((Activity) mContext, mSportsImage, "SportsImage");
                mContext.startActivity(detailIntent, option.toBundle());
            } else {
